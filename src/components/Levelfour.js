...
const Levelone = ({ username, rollnum, initialScore, timeLeft }) => {
  ...
  const hashedPasswords = [
    'ccb9a2af72215108dca55397f83430813991b43afd652e6625288a7b120a65e5',
    ...
    'fbe32033146f1b53ede5d02cd22abeca346220699721bfdf6c58d43074b05c40',
    '8b5ea74fe9afe3697aad3a1f9d8dae901332ef62eece47fb1fb72dfc02e09ae1'
  ];
  ...
  const handleCastSpell = () => {
    const dummyPassword = 'intrusion'; // Dummy password for testing
      ...
      if (fetchResponse.ok) {
        ...
        if (existingDataArray && existingDataArray.length > 0) {
          ...
          if (currentLevel === existingData.level + 1) {
            ...
            const updateResponse = await fetch(`https://json-production-4a9d.up.railway.app/records?rollnum=${rollnum}`, {
            ...
            {isSpellValidated ? (
              ...
              <div className='column'>
                ...
                <h2 className=' animate__animated animate__fadeInRight'> 
                    Decode this Base32 cipher: JFXHI4TVONUW63Q=
                </h2>
