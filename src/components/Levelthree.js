...
const Levelone = ({ username, rollnum, initialScore, timeLeft }) => {
  ...
  const handleCastSpell = () => {
    const dummyPassword = 'virus'; // Dummy password for testing
      ...
      if (fetchResponse.ok) {
        ...
        if (existingDataArray && existingDataArray.length > 0) {
          ...
          if (currentLevel === existingData.level + 1) {
            ...
            const updateResponse = await fetch(`https://jsonserver-production-dc15.up.railway.app/books/${existingData.id}`, {
            ...
            {isSpellValidated ? (
              ...
              <div className='column'>
                ...
                <h2 className=' animate__animated animate__fadeInRight'> 
                    Decode this HEX: 56 69 72 75 73
                </h2>
